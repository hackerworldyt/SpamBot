...
RIZ_IMG = ALIVE_PIC if ALIVE_PIC else "https://te.legra.ph/file/11595f8155c4e570060c8.jpg""

Riz_Button = [
        [
        Button.url("• sᴜᴘᴘᴏʀᴛ •", "https://t.me/mohthemusician")
        ],
        [
...
RizX_Button = [
        [
        Button.url("CHATTING GRP", "https://t.me/Musicsoulfood"),
        Button.url("sᴜᴘᴘᴏʀᴛ", "https://t.me/mohthemusician")
        ],
        [
